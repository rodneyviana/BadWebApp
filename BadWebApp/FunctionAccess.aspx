<%@ Page Title="Access Function" Language="C#" AutoEventWireup="true" CodeBehind="FunctionAccess.aspx.cs" MasterPageFile="~/Site.Master" Inherits="BadWebApp.FunctionAccess" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %>.</h2>
    <h3>This will call an Azure Function.</h3>
    <br />
